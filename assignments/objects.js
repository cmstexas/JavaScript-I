...
const intern4 = {
  "id": 4,
  "name": "Gannie",
  "email": "gmartinson3@illinios.edu",
  "gender": "M"
}
...
const numMultiply = function(num1,num2) {
  return num1*num2;
}
intern5.finalNums = numMultiply;
console.log(intern5.finalNums(2,3));
